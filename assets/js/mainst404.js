...
(function ($) {
  ...
  $mainSlider.slick({
    ...
    fade: true,
    arrows: false,
    prevArrow: '<button class="slick-prev"><img src="https://csrg42.github.io/st404/assets/img/icon/chevron-left.png"</button>',
    nextArrow: '<button class="slick-next"><img src="https://csrg42.github.io/st404/assets/img/icon/chevron-right.png"></button>',
    responsive: [{
      breakpoint: 767,
      settings: {
        dots: false,
  ...
  $.scrollUp({
    ...
    scrollText: '<img src="https://csrg42.github.io/st404/assets/img/icon/arrow-up.png">',
