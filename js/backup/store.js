...
/***/ "./stores/resources/modules/Services/CookieNotificationService.js":
/*!************************************************************************!*\
  !*** ./stores/resources/modules/Services/CookieNotificationService.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, exports) => {

eval("Object.defineProperty(exports, \"__esModule\", ({\n  value: true\n}));\nexports.CookieNotificationService = void 0;\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nfunction _classPrivateFieldGet(receiver, privateMap) { var descriptor = privateMap.get(receiver); if (!descriptor) { throw new TypeError(\"attempted to get private field on non-instance\"); } if (descriptor.get) { return descriptor.get.call(receiver); } return descriptor.value; }\n\nfunction _classPrivateFieldSet(receiver, privateMap, value) { var descriptor = privateMap.get(receiver); if (!descriptor) { throw new TypeError(\"attempted to set private field on non-instance\"); } if (descriptor.set) { descriptor.set.call(receiver, value); } else { if (!descriptor.writable) { throw new TypeError(\"attempted to set read only private field\"); } descriptor.value = value; } return value; }\n\nvar _cookieName = new WeakMap();\n\nvar _cookieTtlDays = new WeakMap();\n\nvar _cookieService = new WeakMap();\n\nvar _cookieValue = new WeakMap();\n\nvar CookieNotificationService = /*#__PURE__*/function () {\n  function CookieNotificationService(cookieService) {\n    _classCallCheck(this, CookieNotificationService);\n\n    _cookieName.set(this, {\n      writable: true,\n      value: 'cookie_consent'\n    });\n\n    _cookieTtlDays.set(this, {\n      writable: true,\n      value: 365\n    });\n\n    _cookieService.set(this, {\n      writable: true,\n      value: void 0\n    });\n\n    _cookieValue.set(this, {\n      writable: true,\n      value: void 0\n    });\n\n    _classPrivateFieldSet(this, _cookieService, cookieService);\n  }\n\n  _createClass(CookieNotificationService, [{\n    key: \"init\",\n    value: function init() {\n      _classPrivateFieldSet(this, _cookieValue, this.getFromCookie());\n    }\n  }, {\n    key: \"getFromCookie\",\n    value: function getFromCookie() {\n      return _classPrivateFieldGet(this, _cookieService).get(_classPrivateFieldGet(this, _cookieName));\n    }\n  }, {\n    key: \"isAcknowledged\",\n    value: function isAcknowledged() {\n      return Number(_classPrivateFieldGet(this, _cookieValue));\n    }\n  }, {\n    key: \"acknowledge\",\n    value: function acknowledge() {\n      _classPrivateFieldGet(this, _cookieService).set(_classPrivateFieldGet(this, _cookieName), 1, _classPrivateFieldGet(this, _cookieTtlDays));\n\n      _classPrivateFieldSet(this, _cookieValue, 1);\n    }\n  }]);\n\n  return CookieNotificationService;\n}();\n\nexports.CookieNotificationService = CookieNotificationService;\n\n//# sourceURL=webpack:///./stores/resources/modules/Services/CookieNotificationService.js?");
